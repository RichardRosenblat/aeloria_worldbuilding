...
- **Ongoing Spell:** If the target is an ongoing spell effect (e.g., _Wall of Force_, _Greater Invisibility_), the caster of the spell must succeed on a spellcasting ability saving throw.
...
5. **Overload:** The effect continues but uncontrollably intensifies (e.g., a _Fireball_ expands by double its normal radius).
