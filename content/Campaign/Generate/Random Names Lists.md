...
# Algorithm for generating names

Algorithym to generate random names for a campaign.

I used this code + [this generator](https://www.fantasynamegenerators.com/) to make all these names.

It is for sure not a really good code or a well written one, but it works and it saved me a loooot of time.
```JavaScript
const rychScript = (
	genOptions,
	numberOfLastNames,
